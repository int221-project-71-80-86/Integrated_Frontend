<template>
  ...
  <div v-else>
    <button @click="back">
      <p v-if="!backTab" class="p-1 hover:bg-gray-500 hover:text-white rounded-lg">Back to Products</p>
    </button>
  </div>
...
export default {
  ...
  data() {
    return {
      backTab: true,
      showTab: "showProducts"
    };
  },
  methods: {
    addTab() {
      this.backTab = false
      this.showTab = "Addproducts"
    },
    back() {
      this.showTab = "showProducts";
      this.backTab = true;
    }
  }
}
